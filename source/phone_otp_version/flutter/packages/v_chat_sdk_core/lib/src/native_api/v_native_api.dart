...
import 'package:v_chat_sdk_core/src/native_api/local/native_local_contact.dart';
...
import '../http/api_service/contacts/contacts_api_service.dart';
...
class VLocalNativeApi {
  ...
  late final NativeLocalContact contacts;
  ...
  Future<VLocalNativeApi> init() async {
    ...
    contacts = NativeLocalContact(database);
...
class VRemoteNativeApi {
  ...
  VContactsApiService get contacts => _nativeContactsService;

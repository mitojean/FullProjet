...
class AppLocalizationsKo extends AppLocalizations {
  ...
  @override
  String get areYouSureToPermitYourCopyThisActionCantUndo => '내 사본을 허용하시겠습니까? 이 작업은 되돌릴 수 없습니다';

  @override
  String get areYouSureToLeaveThisGroupThisActionCantUndo => '이 그룹을 나가시겠습니까? 이 작업은 되돌릴 수 없습니다';
  ...
  @override
  String get weHighRecommendToDownloadThisUpdate => '이 업데이트를 다운로드하는 것을 강력히 권장합니다';
  ...
  @override
  String get userDeviceSessionEndDeviceDeleted => '사용자 기기 세션이 종료되었으며 기기가 삭제되었습니다';

  @override
  String get noCodeHasBeenSendToYouToVerifyYourEmail => '귀하의 이메일을 확인하기 위한 코드가 전송되지 않았습니다';
  ...
  @override
  String get updateGroupDescriptionWillUpdateAllGroupMembers => '그룹 설명을 업데이트하면 모든 그룹 멤버가 업데이트됩니다';
  ...
  @override
  String get allDataHasBeenBackupYouDontNeedToManageSaveTheDataByYourself => '모든 데이터가 백업되었으므로 데이터를 직접 관리할 필요가 없습니다. 다시 로그인하면 모든 채팅이 동일하게 표시됩니다.';
  ...
  @override
  String get enterNameAndAddOptionalProfilePicture => '이름을 입력하고 선택적 프로필 사진을 추가하세요';
  ...
  @override
  String get harassmentOrBullyingDescription => '괴롭힘 또는 괴롭힘: 이 옵션은 사용자가 자신이나 다른 사람을 괴롭히거나 협박하는 개인을 신고하는 데 사용됩니다.';

  @override
  String get spamOrScamDescription => '스팸 또는 사기: 이 옵션은 스팸 메시지, 무단 광고 메시지를 보내는 계정 또는 다른 사람을 사기치려고 하는 계정을 신고하는 데 사용됩니다.';
  ...
  @override
  String get inappropriateContentDescription => '부적절한 콘텐츠: 사용자는 성적으로 음란한 자료, 혐오 발언 또는 공동체 기준을 위반하는 기타 콘텐츠를 신고하기 위해이 옵션을 선택할 수 있습니다.';

  @override
  String get otherCategoryDescription => '기타: 이 옵션은 위의 카테고리에 쉽게 포함되지 않는 위반 사항에 사용할 수 있습니다. 사용자가 추가 세부 정보를 제공할 수 있도록 텍스트 상자를 포함하는 것이 도움이 될 수 있습니다.';
  ...
  @override
  String get aboutToBlockUserWithConsequences => '이 사용자를 차단하려고 합니다. 그에게 채팅을 보낼 수 없으며 그룹이나 방송에 추가할 수 없습니다!';

  @override
  String get youAreAboutToDeleteYourAccountYourAccountWillNotAppearAgainInUsersList => '계정을 삭제하려고 합니다. 계정은 사용자 목록에 다시 나타나지 않습니다';
  ...
  @override
  String get loginNowAllowedNowPleaseTryAgainLater => '현재 로그인이 허용되지 않았습니다. 나중에 다시 시도하세요.';
  ...
  @override
  String get ifThisOptionEnabledTheVideoAndVoiceCallWillBeAllowed => '이 옵션이 활성화되면 비디오 및 음성 통화가 허용됩니다';
  ...
  @override
  String get ifThisOptionDisabledTheSendChatFilesImageVideosAndLocationWillBeBlocked => '이 옵션이 비활성화된 경우 채팅 파일, 이미지, 비디오 및 위치 전송이 차단됩니다';

  @override
  String get allowSendMedia => '미디어 전송 허용';

  @override
  String get ifThisOptionDisabledTheCreateChatBroadcastWillBeBlocked => '이 옵션이 비활성화된 경우 채팅 방송 생성이 차단됩니다';

  @override
  String get allowCreateBroadcast => '방송 생성 허용';

  @override
  String get ifThisOptionDisabledTheCreateChatGroupsWillBeBlocked => '이 옵션이 비활성화된 경우 채팅 그룹 생성이 차단됩니다';

  @override
  String get allowCreateGroups => '그룹 생성 허용';

  @override
  String get ifThisOptionDisabledTheDesktopLoginOrRegisterWindowsMacWillBeBlocked => '이 옵션이 비활성화된 경우 데스크톱 로그인 또는 등록 (Windows 및 macOS)이 차단됩니다';

  @override
  String get allowDesktopLogin => '데스크톱 로그인 허용';

  @override
  String get ifThisOptionDisabledTheWebLoginOrRegisterWillBeBlocked => '이 옵션이 비활성화된 경우 웹 로그인 또는 등록이 차단됩니다';

  @override
  String get ifThisOptionDisabledTheMobileLoginOrRegisterWillBeBlockedOnAndroidIosOnly => '이 옵션이 활성화된 경우 Google 광고 배너가 채팅에 표시됩니다';
  ...
  @override
  String get nowYouLoginAsReadOnlyAdminAllEditYouDoneWillNotAppliedDueToThisIsTestVersion => '현재 읽기 전용 관리자로 로그인되었습니다. 이것은 테스트 버전이므로 수행한 모든 편집은 적용되지 않습니다.';
  ...
  @override
  String get yourProfileAppearsInPublicSearchAndAddingForGroups => '귀하의 프로필은 공개 검색 및 그룹 추가에 표시됩니다';
  ...
  @override
  String get clickThisOptionWillClearAppStorage => '이 옵션은 앱 스토리지를 지웁니다. 자동 다운로드가 활성화되어 있으면 언제든지 다시 다운로드할 수 있으니 걱정하지 마세요. 메시지가 자동으로 다운로드됩니다.';

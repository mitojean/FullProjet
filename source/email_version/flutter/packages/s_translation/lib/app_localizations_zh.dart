...
class AppLocalizationsZh extends AppLocalizations {
  ...
  @override
  String get areYouSureToPermitYourCopyThisActionCantUndo => '您确定要允许复制吗？此操作无法撤销';

  @override
  String get areYouSureToLeaveThisGroupThisActionCantUndo => '您确定要离开此群组吗？此操作无法撤销';
  ...
  @override
  String get noCodeHasBeenSendToYouToVerifyYourEmail => '尚未发送验证码到您的电子邮件以验证您的电子邮件';
  ...
  @override
  String get updateGroupDescriptionWillUpdateAllGroupMembers => '更新群组描述将更新所有群组成员';
  ...
  @override
  String get allDataHasBeenBackupYouDontNeedToManageSaveTheDataByYourself => '所有数据已备份，您无需自行管理数据保存！如果您注销然后重新登录，您将看到与Web版本相同的所有聊天记录';
  ...
  @override
  String get harassmentOrBullyingDescription => '骚扰或欺凌：此选项允许用户举报针对他们或其他人的骚扰消息、威胁或其他形式的欺凌。';

  @override
  String get spamOrScamDescription => '垃圾邮件或欺诈：此选项可用于举报发送垃圾邮件消息、未经请求的广告或试图欺诈他人的帐户。';
  ...
  @override
  String get inappropriateContentDescription => '不适当内容：用户可以选择此选项以举报任何涉及性暴露、仇恨言论或其他违反社区标准的内容。';

  @override
  String get otherCategoryDescription => '其他：这是一个通用类别，适用于不容易归类到上述类别的违规行为。可以提供一个文本框供用户提供额外的细节。';
  ...
  @override
  String get aboutToBlockUserWithConsequences => '您即将屏蔽此用户。您将无法向他发送消息，也无法将他添加到群组或广播中！';

  @override
  String get youAreAboutToDeleteYourAccountYourAccountWillNotAppearAgainInUsersList => '您即将删除您的帐号，您的帐号将不再出现在用户列表中';
  ...
  @override
  String get ifThisOptionEnabledTheVideoAndVoiceCallWillBeAllowed => '如果启用此选项，视频和语音通话将被允许';
  ...
  @override
  String get ifThisOptionDisabledTheSendChatFilesImageVideosAndLocationWillBeBlocked => '如果禁用此选项，将阻止发送聊天文件、图片、视频和位置信息';

  @override
  String get allowSendMedia => '允许发送媒体文件';

  @override
  String get ifThisOptionDisabledTheCreateChatBroadcastWillBeBlocked => '如果禁用此选项，将阻止创建聊天广播';

  @override
  String get allowCreateBroadcast => '允许创建广播';

  @override
  String get ifThisOptionDisabledTheCreateChatGroupsWillBeBlocked => '如果禁用此选项，将阻止创建聊天群组';

  @override
  String get allowCreateGroups => '允许创建群组';

  @override
  String get ifThisOptionDisabledTheDesktopLoginOrRegisterWindowsMacWillBeBlocked => '如果禁用此选项，将阻止桌面登录或注册（Windows 和 macOS）';

  @override
  String get allowDesktopLogin => '允许桌面登录';

  @override
  String get ifThisOptionDisabledTheWebLoginOrRegisterWillBeBlocked => '如果禁用此选项，将阻止Web登录或注册';

  @override
  String get ifThisOptionDisabledTheMobileLoginOrRegisterWillBeBlockedOnAndroidIosOnly => '如果启用此选项，Google Ads 横幅将出现在聊天中';
  ...
  @override
  String get nowYouLoginAsReadOnlyAdminAllEditYouDoneWillNotAppliedDueToThisIsTestVersion => '现在您以只读管理员身份登录。由于这是测试版本，您所做的所有编辑都将不会生效。';
  ...
  @override
  String get yourProfileAppearsInPublicSearchAndAddingForGroups => '您的个人资料将显示在公共搜索和添加到群组中';
  ...
  @override
  String get clickThisOptionWillClearAppStorage => '此选项将清除应用程序存储。不用担心，如果启用自动下载，你仍然可以随时重新下载它。消息将自动下载';

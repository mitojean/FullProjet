...
class AppLocalizationsJa extends AppLocalizations {
  ...
  @override
  String get areYouSureToPermitYourCopyThisActionCantUndo => 'コピーを許可しますか？このアクションは元に戻せません';

  @override
  String get areYouSureToLeaveThisGroupThisActionCantUndo => 'このグループを退席しますか？このアクションは元に戻せません';
  ...
  @override
  String get youAreAboutToDeleteThisUserFromYourList => 'このユーザーをリストから削除しようとしています';
  ...
  @override
  String get congregationsYourAccountHasBeenAccepted => 'おめでとうございます、アカウントが承認されました';
  ...
  @override
  String get updateGroupDescriptionWillUpdateAllGroupMembers => 'グループの説明を更新すると、すべてのグループメンバーに適用されます';
  ...
  @override
  String get allDataHasBeenBackupYouDontNeedToManageSaveTheDataByYourself => 'すべてのデータはバックアップされ、データの管理は必要ありません。ログアウトして再ログインすると、ウェブバージョンと同じチャットが表示されます';
  ...
  @override
  String get enterNameAndAddOptionalProfilePicture => '名前を入力し、オプションのプロフィール画像を追加';
  ...
  @override
  String get harassmentOrBullyingDescription => '嫌がらせやいじめ：このオプションを使用して、嫌がらせメッセージ、脅迫、またはその他のいじめ行為を行っている個人を報告できます。';

  @override
  String get spamOrScamDescription => 'スパムまたは詐欺：このオプションは、スパムメッセージ、不要な広告を送信しているアカウント、または他のユーザーを騙そうとしているアカウントを報告するためのものです。';
  ...
  @override
  String get inappropriateContentDescription => '不適切なコンテンツ：ユーザーは、性的に露骨なコンテンツ、ヘイトスピーチ、またはコミュニティの基準に違反するその他のコンテンツを報告するためにこのオプションを選択できます。';

  @override
  String get otherCategoryDescription => 'その他：上記のカテゴリに簡単に適合しない違反に使用できるキャッチオールカテゴリです。ユーザーが追加の詳細を提供できるように、テキストボックスを含めるのが役立つかもしれません。';
  ...
  @override
  String get yourSessionIsEndedPleaseLoginAgain => 'セッションが終了しました。もう一度ログインしてください。';

  @override
  String get aboutToBlockUserWithConsequences => 'このユーザーをブロックしようとしています。彼にチャットを送信したり、グループまたはブロードキャストに追加したりすることはできません！';

  @override
  String get youAreAboutToDeleteYourAccountYourAccountWillNotAppearAgainInUsersList => 'アカウントを削除しようとしています。アカウントはユーザーリストに再表示されません';
  ...
  @override
  String get loginNowAllowedNowPleaseTryAgainLater => '現在、ログインは許可されていません。後でもう一度お試しください。';
  ...
  @override
  String get ifThisOptionEnabledTheVideoAndVoiceCallWillBeAllowed => 'このオプションが有効になっている場合、ビデオ通話および音声通話が許可されます';
  ...
  @override
  String get ifThisOptionDisabledTheSendChatFilesImageVideosAndLocationWillBeBlocked => 'このオプションが無効になっている場合、チャットファイル、画像、ビデオ、および位置情報の送信がブロックされます';

  @override
  String get allowSendMedia => 'メディアの送信を許可';

  @override
  String get ifThisOptionDisabledTheCreateChatBroadcastWillBeBlocked => 'このオプションが無効になっている場合、チャットブロードキャストの作成がブロックされます';

  @override
  String get allowCreateBroadcast => 'ブロードキャストの作成を許可';

  @override
  String get ifThisOptionDisabledTheCreateChatGroupsWillBeBlocked => 'このオプションが無効になっている場合、チャットグループの作成がブロックされます';

  @override
  String get allowCreateGroups => 'グループの作成を許可';

  @override
  String get ifThisOptionDisabledTheDesktopLoginOrRegisterWindowsMacWillBeBlocked => 'このオプションが無効になっている場合、デスクトップログインまたは登録（WindowsおよびmacOS）がブロックされます';

  @override
  String get allowDesktopLogin => 'デスクトップログインを許可';

  @override
  String get ifThisOptionDisabledTheWebLoginOrRegisterWillBeBlocked => 'このオプションが無効になっている場合、Webログインまたは登録がブロックされます';

  @override
  String get ifThisOptionDisabledTheMobileLoginOrRegisterWillBeBlockedOnAndroidIosOnly => 'このオプションが有効になっている場合、Google広告バナーがチャットに表示されます';
  ...
  @override
  String get nowYouLoginAsReadOnlyAdminAllEditYouDoneWillNotAppliedDueToThisIsTestVersion => '現在、読み取り専用の管理者としてログインしています。これはテストバージョンのため、行ったすべての編集が適用されません。';
  ...
  @override
  String get yourProfileAppearsInPublicSearchAndAddingForGroups => 'あなたのプロフィールは、パブリック検索とグループへの追加に表示されます';
  ...
  @override
  String get oneTimeSeen => '一回だけ閲覧済み';
  ...
  @override
  String get confirmYourPassword => 'パスワードを認証してください';
  ...
  @override
  String get registrationSuccessful => '登録が成功しました！';

  @override
  String get loginSuccessful => 'ログインに成功しました！';

  @override
  String get forgotPassword => 'パスワードを忘れましたか？';

  @override
  String get forgotPasswordNavigating => 'パスワードを忘れた場合のページに移動します';

  @override
  String get dontHaveAnAccount => 'アカウントをお持ちではありませんか？';

  @override
  String get enterTheCodeAndNewPassword => 'メールに送信された認証コードを入力して、新しいパスワードを作成してください';
  ...
  @override
  String get pleaseEnterValidCode => '有効な6桁のコードを入力してください';

  @override
  String get didntReceiveCode => 'コードを受信しませんでしたか？';

  @override
  String get resend => '再送信';

  @override
  String get codeSentAgain => 'コードがメールに再送信されました';

  @override
  String get clickToJoin => 'クリックして参加する';

  @override
  String get storeUrls => 'ストアのURL';

  @override
  String get clearAllCache => 'すべてのキャッシュをクリアする';

  @override
  String get clickThisOptionWillClearAppStorage => 'このオプションはアプリのストレージをクリアします。自動ダウンロードが有効になっている場合は、いつでも再ダウンロードできますのでご心配なく。メッセージは自動的にダウンロードされます';

  @override
  String get deleteAppCache => 'アプリのキャッシュを削除しますか？';

  @override
  String get userRegisterStatus => 'ユーザー登録ステータス';

  @override
  String get isPrime => '素数ですか';
}
